...
def main():
    ...
    loader = CombinedDataset("data/recons_supp", "data/recons_lab", "data/recons_supp5", "data/recons_lab_test", val_split=0.05, constant_fps=True)
    ...
    # save as npy file
    np.save(f'/home/pingpong-daniel/data_danny/match{match_no}/match{match_no}_{rally_no}/match{match_no}_{rally_no}_pred.npy', pred_ball_poss)
    renderer.save()
    renderer.render()
