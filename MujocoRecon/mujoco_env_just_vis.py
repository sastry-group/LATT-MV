...
<mujoco model="table_tennis">
    <include file="iiwa14_gantry_just_vis.xml"/>
...
class KukaTennisEnv(gym.Env):
    ...
    def render(self, mode="human"):
        ...
        if self.viewer is None:
            ...
            self.viewer.cam.distance = 7.21#4.1
        ...
        # if self.current_step > 50 and self.current_step < 150 :
